  ...
  const experiences = [
    {
      ...
      achievements: [
        ...
        'Spearheaded Digital Commerce launch across 16 European countries, 6 currencies, and 11 languages, enabling scalable expansion, localized market access, and enhanced consumer reach.',
        ...
        'Drove omnichannel experience strategy and implementation for high-impact retail solutions including Buy Online Return In-Store (BORIS) and Endless Aisle.',
        ...
        'Architected and delivered headless commerce and SFCC/SFRA platform solutions, implementing Vertex Tax, payment integrations, and API-first architecture to support global scalability and performance.',
      ],
    },
    {
